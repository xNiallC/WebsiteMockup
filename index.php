          ...
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
            ...
            <a class="dropdown-item" href="#">
              <span class="text-success">
                <strong>
                  <i class="fa fa-long-arrow-up fa-fw"></i>Regular Search</strong>
              </span>
              <div class="dropdown-message small">Search for assigned patients only.</div>
            </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#">
              <span class="text-danger">
                <strong>
                  <i class="fa fa-long-arrow-down fa-fw"></i>Emergency Search</strong>
              </span>
              <div class="dropdown-message small">Search all patients. Connection is logged.</div>
            </a>
